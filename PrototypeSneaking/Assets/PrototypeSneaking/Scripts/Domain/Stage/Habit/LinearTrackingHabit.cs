...
namespace PrototypeSneaking.Domain.Stage
{
    public class LinearTrackingHabit : CharacterHabit
    {
        ...
        [SerializeField] private WonderHabit wonderHabit;
        ...
        public override void TellParent(Automonus character, Sight sight, NavMeshAgent agent)
        {
            base.TellParent(character, sight, agent);
            this.character = character;
            this.agent = agent;
            this.sight = sight;
            DisableAgent();
            wonderHabit.TellParent(character, sight, agent);
        }
